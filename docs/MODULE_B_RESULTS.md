...
> 驗證「人工→真實」泛化（baseline 1.00 → 真實 0.20、落差 0.80）。**CE1 領域自適應（2026-06-28）**：
> 無監督仿射對齊修不動（CORAL 0.038 / z-score 0.189，皆 ≤ baseline 0.20），few-shot 每類 10 筆真實標籤
> →macro-F1 0.54。規格與結果見 [`MODULE_C_PADERBORN_PLAN.md`](MODULE_C_PADERBORN_PLAN.md)、
